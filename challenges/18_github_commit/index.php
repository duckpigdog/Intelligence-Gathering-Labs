...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $flag = $_POST['flag'] ?? '';
    if ($flag === 'flag{3d559a8c-8bb8-4c42-afdf-e5a57759a687}') {
...
<head>
    <meta charset="UTF-8">
    <title>Level 18 - GitHub 提交泄露</title>
...
<body>
    <div class="container">
        <h1>LEVEL 18: GitHub 提交泄露</h1>
        <p>目标：收集开源项目 Standalone-Admin 中开发者不小心泄露的 flag</p>
